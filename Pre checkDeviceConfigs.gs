function pre_fetchAllMerakiManagementInterfaces() {
  ...
  const targetSheet = spreadsheet.getSheetByName('Pre config check');
...
function onOpen() {
  ...
  ui.createMenu('Meraki Tools')
    .addItem('Fetch All Management Interfaces', 'pre_fetchAllMerakiManagementInterfaces')
    .addToUi();
}